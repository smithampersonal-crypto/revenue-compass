...
describe("ARC app shell (Phase 5)", () => {
  ...
  it("renders the compact recruiter-facing landing hierarchy", async () => {
    ...
    expect(
      screen.getByText(
        "AI interprets the contract. Deterministic accounting engines calculate the results. You review and control the judgments.",
      ),
    ).toBeInTheDocument();
    expect(
      screen.getByText(
        "Produce an auditable ASC 606 analysis from contract review through allocation, revenue schedules, balances and journal entries.",
      ),
    ).toBeInTheDocument();
