                    ...
                    <div className="space-y-1 text-sm">
                      ...
                      {draft.performanceObligations.length === 0 ? (
                        <p className="text-muted-foreground">
                          No performance obligations entered yet.
                        </p>
                      ) : null}
                    </div>
                  </Field>
                      ...
                      <div key={po.id} className="space-y-3 rounded-md border border-border p-3">
                            ...
                            <>
                              ...
                              <Field label="Service end">
                                <input
                                  ...
                                  value={po.serviceEnd}
                                  onChange={(e) =>
                                    setPo(mod.id, po.id, { serviceEnd: e.target.value })
                                  }
                                />
                              </Field>
                            </>
                        ...
                        <Field label="Remaining-goods distinctness rationale">
                          <NarrativeTextarea
                            ...
                            onChange={(e) =>
                              setPo(mod.id, po.id, {
                                remainingDistinctnessRationale: e.target.value,
                              })
                            }
                          />
                        </Field>
                        ...
                        <button
                          ...
                          onClick={() =>
                            setMod(mod.id, {
                              modifiedPerformanceObligations:
                                mod.modifiedPerformanceObligations.filter(
                                  (row) => row.id !== po.id,
                                ),
                            })
                          }
