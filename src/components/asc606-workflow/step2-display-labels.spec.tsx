...
describe("Step 2 display labels", () => {
  it("edits Name and Description / Interpretation independently", () => {
    ...
    const nameTarget = document.querySelector('[data-ai-review-target="promise:promise-saas.displayName"]');
  ...
  it("uses concise dated labels while retaining canonical assignment IDs", () => {
    ...
    expect(screen.getAllByText("Hosted SaaS Access · 7/1/2027–6/30/2028").length).toBeGreaterThan(0);
