...
function policySection(): string {
  return [
    ...
    "- Never provide only the first and last anchors of a longer section. Never skip intervening segment ids. Never cite more than 3 text anchors for one citation.",
