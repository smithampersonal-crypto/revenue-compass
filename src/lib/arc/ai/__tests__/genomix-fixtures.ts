/**
 * ARC v1 — shared Genomix fixtures for the Safe Re-analysis suites.
 *
...
export const FINGERPRINT = "sha256:genomix-source-set";
export const DOC = "doc-fixture-1";

export function quote(page: number, excerpt: string) {
  return [
    { documentId: DOC, pageStart: page, pageEnd: page, evidenceMode: "text" as const, excerpt },
  ];
}

export const HOSTED = quote(
  2,
 ...
 */
export function genomixAnalysis(): AiContractAnalysis {
...
export function driftedAnalysis(): AiContractAnalysis {
...
export function accountantState() {
