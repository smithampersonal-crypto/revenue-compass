  ...
  promises: [
    {
      ...
      description:
        "Stand-ready hosted access to the HelixFlow CLIA/CAP multi-tenant variant-calling platform during the subscription term, including the contracted capacity of up to 50,000 samples per year.",
    ...
    },
    {
      ...
      description:
        "Dedicated clinical bioinformatics engineering support, stated as 40 hours in each annual commercial schedule.",
      distinctConclusion: "yes",
      citations: [{ documentId: "71a48e73-7496-44c8-b611-2dca9d3ed256", pageStart: 3, pageEnd: 3 }],
    },
  ],
  performanceObligations: [
    {
      ...
      description:
        "A series of stand-ready hosted SaaS platform-access services over the 24-month order-form term, including the annual 50,000-sample throughput capacity as a quantity/capacity attribute of that service.",
    ...
    },
    {
      ...
      description:
        "Dedicated clinical bioinformatics engineering support services up to the contracted hours.",
  ...
  variableConsiderationComponents: [
    {
      ...
      type: "usage",
      description:
        "Conditional Tier 2 specimen throughput overages beyond the included annual throughput tier.",
      unitDescription:
        "USD per sample for Tier 2 overage beyond the included annual 50,000-sample tier",
    ...
    },
    {
      ...
      type: "service_credit",
      description:
        "Conditional monthly service credits of 15%, 30%, or 50% of the monthly platform fee when measured availability falls below the stated thresholds; credits require a written customer request within 15 days after month-end and are applied against subsequent quarterly invoices.",
      unitDescription:
        "Percentage of monthly recurring SaaS platform license fee: 15%, 30%, or 50%, depending on monthly measured availability",
      billingFrequency: "monthly",
      trigger:
        "Monthly measured availability is below 99.95% and Customer timely submits the required written request.",
      contractualRateOrAmountInput: null,
      targetPerformanceObligationKey: "po_hosted_platform_series",
      citations: [{ documentId: "71a48e73-7496-44c8-b611-2dca9d3ed256", pageStart: 4, pageEnd: 4 }],
    },
  ],
  billingTerms: [
    {
      ...
      description:
        "Fixed annual contract value billed annually in advance for the subscription package.",
      frequency: "annual",
    ...
    },
    {
      ...
      description:
        "Tier 2 specimen-throughput overage charge for usage beyond the included annual tier.",
      frequency: "quarterly",
      billingTiming: "on_usage",
      invoiceTrigger:
        "Tier 2 specimen throughput overage occurs; the order form states that overage is billed quarterly.",
      dueDateRule: "Net 30 days from invoice date.",
      paymentTermsDays: 30,
    ...
    },
    {
      ...
      description:
        "Conditional SLA credit applied against a subsequent quarterly invoice after Customer submits a written request within 15 days of month-end.",
      frequency: "quarterly",
      billingTiming: "on_usage",
      invoiceTrigger:
        "Customer timely requests an earned service credit after a monthly availability result below the applicable threshold.",
      dueDateRule: null,
