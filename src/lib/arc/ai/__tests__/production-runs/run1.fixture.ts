  ...
  promises: [
    {
      ...
      description: "Continuous access to the HelixFlow Cloud CLIA/CAP multi-tenant variant-calling suite for two sites during the subscription term, including the contracted annual high-throughput tier of up to 50,000 samples.",
    ...
    },
    {
      ...
      promiseType: "hosted_service",
      description: "Annual capacity of up to 50,000 samples under the high-throughput whole exome/genome tier.",
    ...
    },
    {
      ...
      description: "Dedicated clinical bioinformatics engineering support hours, stated as 40 hours annually.",
      distinctConclusion: "yes",
      citations: [
        { documentId: "71a48e73-7496-44c8-b611-2dca9d3ed256", pageStart: 3, pageEnd: 3 },
      ],
  ...
  performanceObligations: [
    {
      ...
      description: "A series of daily hosted HelixFlow platform-access and availability services over the 24-month subscription term, at the contracted two-site scope and including up to 50,000 samples annually.",
    ...
    },
    {
      ...
      description: "Dedicated clinical bioinformatics engineering support, stated as 40 hours annually.",
  ...
  variableConsiderationComponents: [
    {
      ...
      type: "usage",
      description: "Usage-based charge for sample throughput beyond the included annual high-throughput tier.",
      unitDescription: "USD per sample above the contracted annual throughput tier",
      billingFrequency: "quarterly",
      trigger: "Tier overtaking: sample usage exceeding the included tier; the order form states the overage is billed quarterly at $1.35 per sample.",
    ...
    },
    {
      ...
      type: "service_credit",
      description: "Credits against recurring SaaS platform license fees if monthly measured availability falls below 99.95%.",
      unitDescription: "15%, 30%, or 50% of the applicable monthly platform fee, based on the measured-availability tier",
      billingFrequency: "quarterly",
      trigger: "Monthly measured availability below 99.95%, followed by Customer's written request within 15 days after month-end; credit is applied against subsequent quarterly invoices.",
  ...
  billingTerms: [
    {
      ...
      description: "Fixed annual contract value billed annually in advance for the contracted subscription, validation package, and support-hours components.",
      frequency: "annual",
    ...
    },
    {
      ...
      description: "Incremental specimen-tier overages billed quarterly at the stated per-sample rate.",
      frequency: "quarterly",
    ...
    },
    {
      ...
      description: "SLA service credits are applied against subsequent quarterly invoices when Customer submits the required written request within 15 days of month-end.",
      frequency: "quarterly",
      billingTiming: "on_usage",
      invoiceTrigger: "Customer's timely written request following a monthly availability result within a service-credit tier.",
      dueDateRule: null,
