...
- [ ] Add one controlled auto-growing workflow narrative textarea with a compact minimum and 304px cap
- [ ] Apply it only to the approved accounting narrative and documentation fields
- [ ] Give each Step 4 obligation one concise heading and aligned SSP/documentation controls
- [ ] Rename only the primary Step 4 result heading to Transaction Price Allocation
- [ ] Run focused and full verification, live-check Horizon, package the clean repository, and stop before 2C-F
